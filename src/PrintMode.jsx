			...
			<div className="profile cv-box">
				<div className="profile-infos-1">
					...
					<div className="profile-picture-container">
						<img src={cvData.profil.avatar.value === "" ? cvData.profil.avatar.placeholder : cvData.profil.avatar.value} alt="" className="profile-picture"/>
					</div>
				...
				<div className="profile-infos-2">
					<div className='profile-info graduation-icon'>
						...
						<p className="profile-title text-icon">
							{cvData.profil.jobtitle.value === "" ? cvData.profil.jobtitle.placeholder : cvData.profil.jobtitle.value}
						</p>
					...
					<div className='profile-info phone-icon'>
						...
						<p className="profile-phone-number text-icon">
							{cvData.profil.phonenumber.value === "" ? cvData.profil.phonenumber.placeholder : cvData.profil.phonenumber.value}
						</p>
					...
					<div className='profile-info mail-icon'>
						...
						<p className="profile-mail text-icon">
							{cvData.profil.email.value === "" ? cvData.profil.email.placeholder : cvData.profil.email.value}
						</p>
					</div>
				</div>
			</div>
				...
				<div className="left-column cv-column">
					<div className="intro cv-box">
						...
						<div className="intro-aboutme">
							...
							<p className="intro-aboutme-text">
								{cvData.intro.aboutme.value === "" ? cvData.intro.aboutme.placeholder  : cvData.intro.aboutme.value }
							</p>						
						...
						<div className="intro-link">
							...
							<p className="intro-link-text">
								{cvData.intro.websiteurl.value === "" ? cvData.intro.websiteurl.placeholder  : cvData.intro.websiteurl.value }
							</p>
